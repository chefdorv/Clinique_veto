...
public class PersonnelDAOjdbcImpl implements PersonnelsDAO {
    ...
    public Personnel read(int id) throws DALException {
        ...
        try {
            ...
            if (rs.next()) {
                try {
                    perso = new Personnel(rs.getInt("Code"), rs.getString("Nom"), rs.getString("Mot de passe"), rs.getString("Role"), rs.getBoolean("Archive"));
                } catch (SQLException e) {
    ...
    public List<Personnel> selectAll() throws DALException, BLLException {
        ...
        try {
            ...
            while (rs.next()) {
                try {
                    perso = new Personnel(rs.getInt("CodePers"), rs.getString("Nom"),
